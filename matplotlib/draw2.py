...
baseline_acc .append((int)(1281167.0/1900))
baseline_acc.append((int)(1281167./1800))
baseline_acc.append(int(1281167./1487))
baseline_acc.append(int(1281167./853))
baseline_acc.append(int(1281167./609))
x=[8,16,32,64,128]
l1, = plt.plot(x, baseline_acc[0:number], label = 'line', marker='o',markersize=2.0,color = 'b', linewidth = 1.0, linestyle = '-')
...
y=[27,42,58,51,68,69,74]
print(baseline_acc)
for a, b in zip(x, baseline_acc):
    plt.text(a, b, (a,b),ha='center', va='bottom', fontsize=8)
# 设置坐标轴的lable
plt.xlabel('GPU numbers')
# plt.ylabel('loss')
plt.ylabel('Images / per second ')
# 设置legend
# plt.legend(handles = [l1], labels = ['baseline'], loc = 'best')
plt.grid()
# plt.show()
